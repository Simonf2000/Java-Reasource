...
![image-20211127201850002](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127201850002.png)
...
![](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/MySQL数据库管理系统--》数据库--》表格.png)

![image-20210902124232416](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20210902124232416.png)
...
![image-20221106140425671](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20221106140425671.png)
...
![image-20221106142509471](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20221106142509471.png)
...
![](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/SQL语言是什么.png)
...
![image-20230524142605342](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20230524142605342.png)
...
![image-20220222174512444](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20220222174512444.png)
...
![image-20220207094511797](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20220207094511797.png)
...
![image-20211127205706588](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127205706588.png)
...
![image-20211127210358326](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127210358326.png)
...
![image-20211127210547156](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127210547156.png)

二进制字符串类型：

![image-20211127210608685](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127210608685.png)
...
![image-20211127210826463](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127210826463.png)
...
![image-20211127211743925](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211743925.png)

SET类型的字段在赋值时，可从定义的值列表中选择1个或多个值的组合。SET列最多可以有64个成员。SET值在内部也用整数表示，分别是1，2，4，8……，都是2的n次方值，因为这些整数值对应的二进制都是只有1位是1，其余是0。

![image-20211127211806889](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211806889.png)
...
![image-20211129113339215](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129113339215.png)
...
![image-20211129113618420](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129113618420.png)

如果是char和varchar类型等这种文本字符串的话，客户端传给服务器端的字符编码的二进制（基于GBK编码的），并且会把编码方式一并告诉服务器端，服务器接收后会进行转码，存储为utf8的二进制值。例如：t_char表显示正常。

![image-20211129121210653](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129121210653.png)

（2）当我们在可视化工具中，在t_binary表中添加“尚硅谷”时，“尚硅谷”以utf8mb4编码处理，一个汉字是3个字节，“尚硅谷”就有9个字节，而b2和b3最多能存6个字节。

![image-20211129113937292](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129113937292.png)

当我们在可视化工具中，在t_binary表中添加“尚硅”时，“尚硅”以utf8mb4编码处理，一个汉字是3个字节，“尚硅”就有6个字节。

![image-20211129121351993](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129121351993.png)
...
![image-20211129121904497](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211129121904497.png)

第2步，选择“从文件导入”按钮，打开“Open File”对话框，选择图片文件。默认情况下“从文件导入”按钮不可用，去掉“设置为空”前面的对勾，就可以了.

![image-20211127211548441](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211548441.png)

第3步，导入图片成功，

![image-20211127211603606](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211603606.png)

注意， BLOB类型的数据除了受到类型本身大小的限制外，还会受到服务器端“max_allowed_packet”变量值限定的字节值大小限制。如果从客户端给服务器端上传的BLOB数据大小超过该值时会报错。

![image-20211127211628862](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211628862.png)
...
![image-20211127211643824](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127211643824.png)
...
![image-20211127212047635](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127212047635.png)
...
![image-20211127212421863](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127212421863.png)

![image-20211127212433697](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127212433697.png)
...
![image-20211201084442467](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211201084442467.png)

（2）用户自定义函数：由开发人员自己定义的，通过CREATE FUNCTION语句定义，是属于某个数据库的对象。

![image-20211201083845550](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211201083845550.png)
...
![image-20211201000449563](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211201000449563.png)

![image-20220223153723779](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20220223153723779.png)

### 1、A∩B

![A∩B](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/A∩B.png)

### 2、A

![A表](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/A表.png)

### 3、A-A∩B

![A表-（A∩B）](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/A表-（A∩B）.png)

### 4、B



![B表](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/B表.png)

### 5、B-A∩B

![B表-（A∩B）](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/B表-（A∩B）.png)

### 6、A∪B

![A表∪B表](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/A表∪B表.png)

### 7、A∪B - A∩B



![](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/（A表∪B表）-（A∩B）.png)
...
![image-20211127202910546](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127202910546.png)
...
![image-20211127202931893](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127202931893.png)
...
![image-20211127202949314](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211127202949314.png)
...
order by student.sid; #两个表没有直接关联关系，没有编写关联条件

select *
from student inner join score
order by student.sid; #两个表有关联关系，但没有编写关联条件
```

![image-20231008095310107](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20231008095310107.png)
...
![image-20231008095757200](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20231008095757200.png)
...
![image-20231008102931515](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20231008102931515.png)
...
![image-20231008103101012](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20231008103101012.png)
...
（6）ROLLUP（汇总）：对 VT5 进行  ROLLUP 操作，产生表 VT6；
...
-- Records of temp
-- ----------------------------
INSERT INTO `temp` VALUES (1,1001, '张三', '语文', 89);
INSERT INTO `temp` VALUES (2,1001, '张三', '数学', 96);
INSERT INTO `temp` VALUES (3,1001, '张三', '英语', 75);
INSERT INTO `temp` VALUES (4,1002, '李四', '语文', 88);
INSERT INTO `temp` VALUES (5,1002, '李四', '数学', 99);

select * from temp;
```

![image-20230725104707443](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20230725104707443.png)

目标是实现：

![image-20230725104820227](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20230725104820227.png)
...
![image-20230725105040654](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20230725105040654.png)

目标结果：

![image-20230725105150463](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20230725105150463.png)

```sql
#学生的姓名、课程名、成绩等情况
select t_stu.sid,sname,cname,score 
from t_stu left join t_score on t_stu.sid = t_score.sid 
left join t_course on t_course.cid = t_score.cid;
...
![image-20221106194005188](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20221106194005188.png)
...
![image-20221106194044252](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20221106194044252.png)
...
![image-20211202002655521](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211202002655521.png)

![image-20211202002704464](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211202002704464.png)

![image-20211202002714841](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211202002714841.png)

![image-20211202002723256](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20211202002723256.png)
...
![image-20221106170755133](尚硅谷_柴林燕_MySQL8.0_SQL笔记.assets/image-20221106170755133.png)
